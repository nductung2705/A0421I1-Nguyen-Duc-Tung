...
import Exam.ExportedProduct;
import Exam.Product;
import Exam.ReadAndWriteFile;
...
public class ProductManagement {
    ...
    private static void display() {
        productList = (List<Product>) ReadAndWriteFile.read("D:\\l21_final_examination\\l21_final_examination\\l21_final_examination\\products.csv");
    ...
    private static void remove() {
        try{
            ...
            if (scanner.nextLine().equals("Yes")){
                ...
                ReadAndWriteFile.write(productList, "D:\\l21_final_examination\\l21_final_examination\\l21_final_examination\\products.csv");
            }else {
                menu();
            }
        }catch (Exception e){
